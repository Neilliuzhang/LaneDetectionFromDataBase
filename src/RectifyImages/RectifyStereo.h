...
public:
	...
	RectifyStereo(const char* fileName);//load parameter file and compute remap matrix.
	RectifyStereo(string fileName);//load parameter file and compute remap matrix.
